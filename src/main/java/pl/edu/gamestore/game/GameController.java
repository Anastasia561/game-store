...
public class GameController {
    ...
    @GetMapping("/{id}")
    public ResponseWrapper<GameResponseDto> findById(@PathVariable HashId id) {
    ...
    public ResponseWrapper<HashId> create(@Valid @RequestBody GameRequestDto dto) {
    ...
    public void delete(@PathVariable HashId id) {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @PutMapping("/{id}")
    public ResponseWrapper<GameResponseDto> update(@PathVariable HashId id,
